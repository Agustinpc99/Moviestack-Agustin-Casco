...
<div class="flex flex-col gap-5 w-[35vw] justify-evenly">
                ...
                <div class="flex flex-col gap-[10%] w-[35vw] justify-around">
                    <article>
                        <h2 class="text-white text-4xl">${}</h2>
                        <p class="text-white text-xl">${}</p>
                        <p class="text-white">${}</p>
                        <p class="w-[70ch] text-white">${}</p>
                    </article>
                    <div>
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="border text-white text-2xl">USD ${}</td>
                            </tr>
                            <tr>
